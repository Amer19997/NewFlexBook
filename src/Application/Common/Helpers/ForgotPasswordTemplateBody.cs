...
internal class ForgotPasswordTemplateBody
{
    ...
    public string Subject = "تغيير كلمة المرور";
          	...
          	<table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">
          		<tr>
          			<td class=""logo"" style=""text-align: center;"">
			            <h1><a href=""#""><img src=""{ApiUrl}/TemplateEmail/FlexBookLogo.png"" alt="""" srcset=""""></a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
				...
				<tr>
          <td valign=""middle"" class=""hero bg_white"" style=""padding: 0 5rem 4em 5rem; margin-inline: 5rem;"">
            <table>
            	<tr>
            		<td >
            			<div class=""text"" style="" text-align: right;"">
            				...
            				<h2>مرحباً {Name}</h2>
							<p>لقد قمت بطلب استعادة كلمة المرور الخاصة بك  لتعديل كلمة المرور الخاصة بك ، الرقم العشوائى المتغير الخاص بك :{OTP}</p>
