...
namespace LocalNIC.Migrations
{
    ...
    [Migration("20230131193403_RemoveTransparencyStandardTable")]
    partial class RemoveTransparencyStandardTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Waqfi.LocalNIC.Entities.Society", b =>
                {
                    ...
                    b.Property<int>("TransparencyStandard")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Waqfi.LocalNIC.Entities.Society", b =>
                {
                    ...
                    b.HasOne("Waqfi.LocalNIC.Entities.GovernanceClassification", "GovernanceClassification")
                        .WithMany("Societies")
                    ...
                    b.Navigation("GovernanceClassification");
