...
public class StudentsGettingStartedArticle : BaseEntity<Guid>
{
    ...
    public string AuthorName { get; set; } = default!;    // Author name
    public string AuthorPhotoUrl { get; set; } = default!; // Author photo URL
